...
export const PUSH_CREATEROOM_TAG = "PUSH_CREATEROOM_TAG";
export const DELETE_CREATEROOM_TAG = "DELETE_CREATEROOM_TAG";
...
export const pushCreateRoomTag = (tag: string) => {
  return {
    tag,
    type: PUSH_CREATEROOM_TAG
  } as ICreateRoomAction;
};

export const deleteCreateRoomTag = (tag: string) => {
  return {
    tag,
    type: DELETE_CREATEROOM_TAG
  } as ICreateRoomAction;
};
